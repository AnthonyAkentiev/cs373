...
def run(tau, tau2, tau3):
    ...
    for i in range(N):
          ...
          steering = (-tau * cte) - (tau2 * diffCTE) - (tau3 * integralErr)
...
# call function with parameter tau of 0.1 and print results
# Tau is like a "max steering angle"
# If you set tau higher -> will oscilate faster...
run(0.1,3.0,0.004)
